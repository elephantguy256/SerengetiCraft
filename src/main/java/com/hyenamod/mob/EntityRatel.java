...
public class EntityRatel extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityRatel.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityRatel.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityRatel.class, DataSerializers.VARINT);
    ...
    public EntityRatel(World worldIn)
    {
        super(worldIn);
    ...
    {
    	this.tasks.addTask(9, new EntityAIAvoidEntity(this, EntityLion.class, 8.0F, interpTargetPitch, interpTargetPitch));
    	this.tasks.addTask(9, new EntityAIAvoidEntity(this, EntityLioness.class, 8.0F, interpTargetPitch, interpTargetPitch));
    ...
    {
        return this.isAngry() ? SoundEvents2.RATEL : (this.rand.nextInt(3) == 0 ? (this.isTamed() && ((Float)this.dataManager.get(DATA_HEALTH_ID)).floatValue() < 10.0F ? SoundEvents2.RATEL : SoundEvents2.RATEL) : SoundEvents2.RATEL);
    }

    protected SoundEvent getHurtSound()
    {
        return SoundEvents2.RATEL_HURT;
    }
    ...
    public EntityRatel createChild(EntityAgeable ageable)
    {
        EntityRatel entitywolf = new EntityRatel(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityRatel entitywolf = (EntityRatel)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityRatel)
            {
                EntityRatel entitywolf = (EntityRatel)p_142018_1_;
