...
public class EntityBlackLeopard extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityBlackLeopard.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityBlackLeopard.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityBlackLeopard.class, DataSerializers.VARINT);
    ...
    public EntityBlackLeopard(World worldIn)
    {
        super(worldIn);
    ...
    {
        return this.isAngry() ? SoundEvents2.LEOPARD : (this.rand.nextInt(3) == 0 ? (this.isTamed() && ((Float)this.dataManager.get(DATA_HEALTH_ID)).floatValue() < 10.0F ? SoundEvents2.LEOPARD : SoundEvents2.LEOPARD) : SoundEvents2.LEOPARD);
    }
    ...
    public EntityBlackLeopard createChild(EntityAgeable ageable)
    {
        EntityBlackLeopard entitywolf = new EntityBlackLeopard(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityBlackLeopard))
        {
            return false;
        }
        else
        {
            EntityBlackLeopard entitywolf = (EntityBlackLeopard)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityBlackLeopard)
            {
                EntityBlackLeopard entitywolf = (EntityBlackLeopard)p_142018_1_;
