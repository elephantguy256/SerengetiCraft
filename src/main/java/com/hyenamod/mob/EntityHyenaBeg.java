...
public class EntityHyenaBeg extends EntityAIBase
{
    private final EntitySpottedHyena theWolf;
    private EntityPlayer thePlayer;
    private final World worldObject;
    private final float minPlayerDistance;
    private int timeoutCounter;

    public EntityHyenaBeg(EntitySpottedHyena wolf, float minDistance)
    {
        this.theWolf = wolf;
