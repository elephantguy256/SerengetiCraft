...
public class EntityGiraffe2 extends EntityAnimal
{
    public EntityGiraffe2(World worldIn)
    {
        super(worldIn);
    ...
    public EntityGiraffe2 createChild(EntityAgeable ageable)
    {
        return new EntityGiraffe2(this.worldObj);
    }
