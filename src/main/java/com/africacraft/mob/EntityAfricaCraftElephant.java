...
public class EntityAfricaCraftElephant extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityAfricaCraftElephant.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityAfricaCraftElephant.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityAfricaCraftElephant.class, DataSerializers.VARINT);
    ...
    public EntityAfricaCraftElephant(World worldIn)
    {
        super(worldIn);
    ...
    protected void applyEntityAttributes()
    {
        ...
        if (this.isTamed())
        {
            this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(11111111.0D);
        }
        else
        {
            this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(11111111.0D);
        ...
        this.getAttributeMap().registerAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(11111111.0D);
    }
    ...
    {
        return this.isAngry() ? SoundEvents2.ELEPHANT : (this.rand.nextInt(3) == 0 ? (this.isTamed() && ((Float)this.dataManager.get(DATA_HEALTH_ID)).floatValue() < 10.0F ? SoundEvents2.ELEPHANT : SoundEvents2.ELEPHANT) : SoundEvents2.ELEPHANT);
    }
    ...
    public void setTamed(boolean tamed)
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(11111111.0D);
    }
    ...
    public EntityAfricaCraftElephant createChild(EntityAgeable ageable)
    {
        EntityAfricaCraftElephant entitywolf = new EntityAfricaCraftElephant(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityAfricaCraftElephant))
        {
            return false;
        }
        else
        {
            EntityAfricaCraftElephant entitywolf = (EntityAfricaCraftElephant)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityAfricaCraftElephant)
            {
                EntityAfricaCraftElephant entitywolf = (EntityAfricaCraftElephant)p_142018_1_;
