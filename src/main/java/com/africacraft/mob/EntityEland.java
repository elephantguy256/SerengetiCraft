...
public class EntityEland extends EntityAnimal
{
    public EntityEland(World worldIn)
    {
        super(worldIn);
    ...
    public EntityEland createChild(EntityAgeable ageable)
    {
        return new EntityEland(this.worldObj);
    }
