...
public class EntityHippo extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityHippo.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityHippo.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityHippo.class, DataSerializers.VARINT);
    ...
    public EntityHippo createChild(EntityAgeable ageable)
    {
        EntityHippo entitywolf = new EntityHippo(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityHippo))
        {
            return false;
        }
        else
        {
            EntityHippo entitywolf = (EntityHippo)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityHippo)
            {
                EntityHippo entitywolf = (EntityHippo)p_142018_1_;
