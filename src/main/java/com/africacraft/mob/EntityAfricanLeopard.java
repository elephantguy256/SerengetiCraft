...
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityAfricanLeopard.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityAfricanLeopard.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityAfricanLeopard.class, DataSerializers.VARINT);
    ...
    {
        EntityAfricanLeopard entitywolf = new EntityAfricanLeopard(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityAfricanLeopard entitywolf = (EntityAfricanLeopard)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityAfricanLeopard)
            {
                EntityAfricanLeopard entitywolf = (EntityAfricanLeopard)p_142018_1_;
