...
public class EntityBaboon extends EntityAnimal
{
    public EntityBaboon(World worldIn)
    {
        super(worldIn);
    ...
    public EntityBaboon createChild(EntityAgeable ageable)
    {
        return new EntityBaboon(this.worldObj);
    }
